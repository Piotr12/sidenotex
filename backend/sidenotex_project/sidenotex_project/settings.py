"""
Django settings for sidenotex_project project.
...
ROOT_URLCONF = 'sidenotex_project.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'main.context_processors.user_domain',
            ],
        },
    },
]

WSGI_APPLICATION = 'sidenotex_project.wsgi.application'
